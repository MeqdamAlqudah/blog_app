...
# Spork.prefork do
#   # Loading more in this block will
#   # cause your tests to run faster. However,
#   # if you change any configuration
#   # or code from libraries loaded here, you'll
...
#   FactoryGirl.reload
#   load File.join(Rails.root, 'config', 'routes.rb')
# end
